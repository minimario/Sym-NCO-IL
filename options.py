...
def get_options(args=None):
    ...
    # Data
    parser.add_argument('--labelpath', default='expert_data/tsp100_solution.pkl', help="datapath for labeled data")
    ...
    parser.add_argument('--train_dataset', type=str, default="expert_data/tsp100_problem.pkl", help='training labeled data')
    # Model
    ...
    # Training
    parser.add_argument('--label_aug', action='store_true', help='enable labeled data augmentation')
    parser.add_argument('--consistancy_learning', action='store_true', help='enable consistancy learning for unlabeled data')
    ...
    parser.add_argument('--num_input_augmentations', type=int, default=4, help='number of input augmentations')
